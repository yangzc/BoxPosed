 ...
 * threads. All these classes implement the {@link cn.xutils.commons.concurrent.ConcurrentInitializer} interface
 ...
 *
 * <p>
 * A {@link cn.xutils.commons.concurrent.ConcurrentInitializer} produces an object. By calling the
 * {@link cn.xutils.commons.concurrent.ConcurrentInitializer#get() get()} method the object managed by the
 * initializer can be obtained. There are different implementations of the interface available addressing various use
 * cases:
 * </p>
 *
 * <p>
 * {@link cn.xutils.commons.concurrent.ConstantInitializer} is a very straightforward implementation of the
 * {@link cn.xutils.commons.concurrent.ConcurrentInitializer} interface: An instance is passed an object when it
 ...
 * {@link cn.xutils.commons.concurrent.ConcurrentInitializer}.
 * </p>
 *
 * <p>
 * The {@link cn.xutils.commons.concurrent.LazyInitializer} class can be used to defer the creation of an object
 ...
 * {@link cn.xutils.commons.concurrent.LazyInitializer} implements the <em>double-check idiom for an instance
 ...
 * {@link cn.xutils.commons.concurrent.LazyInitializer} comes into play. We create a specialized subclass for
 * creating and initializing an instance of our messaging service.
 * {@link cn.xutils.commons.concurrent.LazyInitializer} declares an abstract
 * {@link cn.xutils.commons.concurrent.LazyInitializer#initialize() initialize()} method which we have to
 ...
 *
 * <p>
 * The {@link cn.xutils.commons.concurrent.AtomicInitializer} class is very similar to
 * {@link cn.xutils.commons.concurrent.LazyInitializer}. It serves the same purpose: to defer the creation of an
 * object until it is needed. The internal structure is also very similar. Again there is an abstract
 * {@link cn.xutils.commons.concurrent.AtomicInitializer#initialize() initialize()} method which has to be
 ...
 *
 * <p>
 * With {@link cn.xutils.commons.concurrent.AtomicSafeInitializer} there is yet another variant implementing the
 * lazy initializing pattern. Its implementation is close to
 * {@link cn.xutils.commons.concurrent.AtomicInitializer}; it also uses atomic variables internally and therefore
 * does not need synchronization. The name &quot;Safe&quot; is derived from the fact that it implements an additional
 * check which guarantees that the {@link cn.xutils.commons.concurrent.AtomicSafeInitializer#initialize()
 * initialize()} method is called only once. So it behaves exactly in the same way as
 * {@link cn.xutils.commons.concurrent.LazyInitializer}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * {@link cn.xutils.commons.concurrent.AtomicInitializer} is probably the most efficient implementation due to
 ...
 * {@link cn.xutils.commons.concurrent.AtomicInitializer} is a good choice.
 * {@link cn.xutils.commons.concurrent.AtomicSafeInitializer} and
 * {@link cn.xutils.commons.concurrent.LazyInitializer} both guarantee that the initialization method is called
 * only once. Because {@link cn.xutils.commons.concurrent.AtomicSafeInitializer} does not use synchronization it
 * is probably slightly more efficient than {@link cn.xutils.commons.concurrent.LazyInitializer}, but the
 * concrete numbers might depend on the level of concurrency.
 * </p>
 *
 * <p>
 * Another implementation of the {@link cn.xutils.commons.concurrent.ConcurrentInitializer} interface is
 * {@link cn.xutils.commons.concurrent.BackgroundInitializer}. It is again an abstract base class with an
 * {@link cn.xutils.commons.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be
 * defined by concrete subclasses. The idea of {@link cn.xutils.commons.concurrent.BackgroundInitializer} is that
 ...
 * specialized implementation of {@link cn.xutils.commons.concurrent.BackgroundInitializer} can be created for
 * this purpose:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * Related to {@link cn.xutils.commons.concurrent.BackgroundInitializer} is the
 * {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer} class. As the name implies, this class can
 * handle multiple initializations in parallel. The basic usage scenario is that a
 * {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer} instance is created. Then an arbitrary number
 * of {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects is added using the
 * {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer#addInitializer(String, cn.xutils.commons.concurrent.BackgroundInitializer)}
 ...
 * {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer#start()} method is called. This starts
 ...
 * {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}. This object
 ...
 *
 * <p>
 * With {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer} we can extend our example to perform
 ...
 * {@link cn.xutils.commons.concurrent.BackgroundInitializer} implementations exist. The following example
 * fragment shows the usage of {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer} for this purpose:
 * </p>
 *
 * <pre>
 * <code>
 ...
 *
 * <p>
 * If background initializers - including {@link cn.xutils.commons.concurrent.MultiBackgroundInitializer} - are
 ...
 * concurrency. There is the {@link cn.xutils.commons.concurrent.ConcurrentUtils} class with a bunch of static
 ...
 *
 * <p>
 * The {@link cn.xutils.commons.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)}
 ...
 * {@link cn.xutils.commons.concurrent.ConcurrentException} is created and initialized with the root cause
 * ({@link cn.xutils.commons.concurrent.ConcurrentException} is a new exception class in the
 * {@code o.a.c.l.concurrent} package). So if you get such a
 * {@link cn.xutils.commons.concurrent.ConcurrentException}, you can be sure that the original cause for the
 ...
 * {@link cn.xutils.commons.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)}
 * method which behaves like {@code extractCause()}, but returns the unchecked exception
 * {@link cn.xutils.commons.concurrent.ConcurrentRuntimeException} instead.
 * </p>
 *
 * <p>
 * In addition to the {@code extractCause()} methods there are corresponding
 * {@link cn.xutils.commons.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and
 * {@link cn.xutils.commons.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)}
 * methods. These methods extract the cause of the passed in {@link java.util.concurrent.ExecutionException} and throw
 * the resulting {@link cn.xutils.commons.concurrent.ConcurrentException} or
 * {@link cn.xutils.commons.concurrent.ConcurrentRuntimeException}. This makes it easy to transform an
 * {@link java.util.concurrent.ExecutionException} into a
 * {@link cn.xutils.commons.concurrent.ConcurrentException} ignoring unchecked exceptions:
 * </p>
 *
 * <pre>
 * <code>
 ...
 * {@code initialize()} method is passed a {@link cn.xutils.commons.concurrent.ConcurrentInitializer} object and
 * returns the object created by this initializer. It is null-safe. The {@code initializeUnchecked()} method works
 * analogously, but a {@link cn.xutils.commons.concurrent.ConcurrentException} throws by the initializer is
 * rethrown as a {@link cn.xutils.commons.concurrent.ConcurrentRuntimeException}. This is especially useful if
 * the specific {@link cn.xutils.commons.concurrent.ConcurrentInitializer} does not throw checked exceptions.
 ...
 *
 * <p>
 * Using the {@link cn.xutils.commons.concurrent.ConcurrentUtils#initializeUnchecked(ConcurrentInitializer)}
 * method, this becomes:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * With {@link cn.xutils.commons.concurrent.BasicThreadFactory} Commons Lang has an implementation of
 ...
 * uncaught exceptions. Instances of {@link cn.xutils.commons.concurrent.BasicThreadFactory} are created and
 * configured using the nested {@link cn.xutils.commons.concurrent.BasicThreadFactory.Builder} class. The
 ...
 *
 * <p>
 * The nested {@link cn.xutils.commons.concurrent.BasicThreadFactory.Builder} class defines some methods for
 * configuring the new {@link cn.xutils.commons.concurrent.BasicThreadFactory} instance. Objects of this class
 ...
 * {@link cn.xutils.commons.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory)
 ...
 *
 * <p>
 * {@link cn.xutils.commons.concurrent.TimedSemaphore} allows restricted access to a resource in a given time
 ...
 * {@link cn.xutils.commons.concurrent.TimedSemaphore#acquire()} method. The semaphore keeps track about the
 ...
 *
 * <p>
 * What are use cases for {@link cn.xutils.commons.concurrent.TimedSemaphore}? One example is to artificially
 ...
 * {@link cn.xutils.commons.concurrent.TimedSemaphore} object this can be achieved. The semaphore can be
 ...
 * has to create an instance of {@link cn.xutils.commons.concurrent.TimedSemaphore} and to initialize its
 ...
 *
 * <p>
 * With the {@link cn.xutils.commons.concurrent.TimedSemaphore#setLimit(int)} method the number of permits
 ...
 * </p>
 */
package cn.xutils.commons.concurrent;
