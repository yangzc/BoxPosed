...
import cn.xutils.commons.Validate;
import cn.xutils.commons.exception.ExceptionUtils;
...
public class ConcurrentUtils {
    ...
    /**
     * Invokes the specified {@link cn.xutils.commons.concurrent.ConcurrentInitializer} and returns the
     * object produced by the initializer. This method just invokes the {@code
     * get()} method of the given {@link cn.xutils.commons.concurrent.ConcurrentInitializer}. It is
     * <b>null</b>-safe: if the argument is <b>null</b>, result is also
     * <b>null</b>.
     *
     * @param <T> the type of the object produced by the initializer
     * @param initializer the {@link cn.xutils.commons.concurrent.ConcurrentInitializer} to be invoked
     * @return the object managed by the {@link cn.xutils.commons.concurrent.ConcurrentInitializer}
     * @throws ConcurrentException if the {@link cn.xutils.commons.concurrent.ConcurrentInitializer} throws
     * an exception
     */
    public static <T> T initialize(final cn.xutils.commons.concurrent.ConcurrentInitializer<T> initializer)
            throws ConcurrentException {
        return initializer != null ? initializer.get() : null;
    }

    /**
     * Invokes the specified {@link cn.xutils.commons.concurrent.ConcurrentInitializer} and transforms
     * occurring exceptions to runtime exceptions. This method works like
     * {@link #initialize(cn.xutils.commons.concurrent.ConcurrentInitializer)}, but if the {@code
     ...
     */
    public static <T> T initializeUnchecked(final cn.xutils.commons.concurrent.ConcurrentInitializer<T> initializer) {
        try {
     ...
     * the {@code get()} method of the passed in {@link cn.xutils.commons.concurrent.ConcurrentInitializer}
     ...
     * @param map the map to be modified
     * @param key the key of the value to be added
     * @param init the {@link cn.xutils.commons.concurrent.ConcurrentInitializer} for creating the value
     * @return the value stored in the map after this operation; this may or may
     * not be the object created by the {@link cn.xutils.commons.concurrent.ConcurrentInitializer}
    ...
    public static <K, V> V createIfAbsent(final ConcurrentMap<K, V> map, final K key,
            final cn.xutils.commons.concurrent.ConcurrentInitializer<V> init) throws ConcurrentException {
