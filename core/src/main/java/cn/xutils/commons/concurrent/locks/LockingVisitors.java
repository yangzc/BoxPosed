 ...
 */
package cn.xutils.commons.concurrent.locks;
...
import cn.xutils.commons.function.FailableConsumer;
import cn.xutils.commons.function.FailableFunction;
 ...
 * </p>
 * <ol>
 * <li>While still in single thread mode, create an instance of {@link StampedLockVisitor} by calling
 ...
 * {@link StampedLockVisitor#acceptReadLocked(FailableConsumer)}, or
 * {@link StampedLockVisitor#acceptWriteLocked(FailableConsumer)}, passing the consumer.</li>
 ...
 * {@link StampedLockVisitor#applyReadLocked(FailableFunction)}, or
 * {@link StampedLockVisitor#applyWriteLocked(FailableFunction)}.</li>
 * </ol>
 * <p>
