 ...
 *
 * <p>
 * This class is an analogue of the {@link cn.xutils.commons.concurrent.ConcurrentException} exception class.
 * However, it is a runtime exception and thus does not need explicit catch
 * clauses. Some methods of {@link cn.xutils.commons.concurrent.ConcurrentUtils} throw {@code
...
public class ConcurrentRuntimeException extends RuntimeException {
    ...
    public ConcurrentRuntimeException(final Throwable cause) {
        super(cn.xutils.commons.concurrent.ConcurrentUtils.checkedException(cause));
    }
