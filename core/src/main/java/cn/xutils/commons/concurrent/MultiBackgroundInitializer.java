...
/**
 * A specialized {@link cn.xutils.commons.concurrent.BackgroundInitializer} implementation that can deal with
 * multiple background initialization tasks.
 *
 * <p>
 * This class has a similar purpose as {@link cn.xutils.commons.concurrent.BackgroundInitializer}. However,
 * it is not limited to a single background initialization task. Rather it
 * manages an arbitrary number of {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects,
 ...
 * with the {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects it is responsible for; so the
 ...
 * is complete.</li>
 * <li>Create specialized {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects for the
 * initialization tasks to be performed and add them to the {@code
 * MultiBackgroundInitializer} using the
 * {@link #addInitializer(String, cn.xutils.commons.concurrent.BackgroundInitializer)} method.</li>
 ...
 * starts all {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects added to the instance.
 ...
 * starts all registered {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects and waits for
...
public class MultiBackgroundInitializer
        extends
        cn.xutils.commons.concurrent.BackgroundInitializer<MultiBackgroundInitializer.MultiBackgroundInitializerResults> {

    /** A map with the child initializers. */
    private final Map<String, cn.xutils.commons.concurrent.BackgroundInitializer<?>> childInitializers = new HashMap<>();
    ...
    /**
     * Adds a new {@link cn.xutils.commons.concurrent.BackgroundInitializer} to this object. When this
     ...
     * @param backgroundInitializer the {@link cn.xutils.commons.concurrent.BackgroundInitializer} to add (must not be
     * <b>null</b>)
     * @throws NullPointerException if either {@code name} or {@code backgroundInitializer}
     *         is {@code null}
     * @throws IllegalStateException if {@code start()} has already been called
     */
    public void addInitializer(final String name, final cn.xutils.commons.concurrent.BackgroundInitializer<?> backgroundInitializer) {
    ...
    protected int getTaskCount() {
        return 1 + childInitializers.values().stream().mapToInt(cn.xutils.commons.concurrent.BackgroundInitializer::getTaskCount).sum();
    }
    ...
    protected MultiBackgroundInitializerResults initialize() throws Exception {
        final Map<String, cn.xutils.commons.concurrent.BackgroundInitializer<?>> inits;
        synchronized (this) {
        ...
        final Map<String, cn.xutils.commons.concurrent.ConcurrentException> excepts = new HashMap<>();
        inits.forEach((k, v) -> {
            try {
                results.put(k, v.get());
            } catch (final cn.xutils.commons.concurrent.ConcurrentException cex) {
                excepts.put(k, cex);
            }
        });
     ...
     * {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects managed by the owning instance. It
     * is also possible to retrieve status information about single
     * {@link cn.xutils.commons.concurrent.BackgroundInitializer}s, i.e. whether they completed normally or
     * caused an exception.
     */
    public static class MultiBackgroundInitializerResults {
        /** A map with the child initializers. */
        private final Map<String, cn.xutils.commons.concurrent.BackgroundInitializer<?>> initializers;

        /** A map with the result objects. */
        private final Map<String, Object> resultObjects;

        /** A map with the exceptions. */
        private final Map<String, cn.xutils.commons.concurrent.ConcurrentException> exceptions;

        /**
         * Creates a new instance of {@link MultiBackgroundInitializerResults}
         * and initializes it with maps for the {@link cn.xutils.commons.concurrent.BackgroundInitializer}
         * objects, their result objects and the exceptions thrown by them.
         *
         * @param inits the {@link cn.xutils.commons.concurrent.BackgroundInitializer} objects
        ...
        private MultiBackgroundInitializerResults(
                ...
                final Map<String, cn.xutils.commons.concurrent.ConcurrentException> excepts) {
            initializers = inits;
        ...
        /**
         * Returns the {@link cn.xutils.commons.concurrent.BackgroundInitializer} with the given name. If the
         * name cannot be resolved, an exception is thrown.
         *
         * @param name the name of the {@link cn.xutils.commons.concurrent.BackgroundInitializer}
         * @return the {@link cn.xutils.commons.concurrent.BackgroundInitializer} with this name
         * @throws NoSuchElementException if the name cannot be resolved
         */
        public cn.xutils.commons.concurrent.BackgroundInitializer<?> getInitializer(final String name) {
         ...
         * {@link cn.xutils.commons.concurrent.BackgroundInitializer} caused an exception, <b>null</b> is
        ...
        /**
         * Returns a flag whether the {@link cn.xutils.commons.concurrent.BackgroundInitializer} with the
        ...
        /**
         * Returns the {@link cn.xutils.commons.concurrent.ConcurrentException} object that was thrown by the
         * {@link cn.xutils.commons.concurrent.BackgroundInitializer} with the given name. If this
        ...
        /**
         * Returns a set with the names of all {@link cn.xutils.commons.concurrent.BackgroundInitializer}
         ...
         */
        private cn.xutils.commons.concurrent.BackgroundInitializer<?> checkName(final String name) {
