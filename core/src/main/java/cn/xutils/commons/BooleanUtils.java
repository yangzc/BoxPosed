...
public class BooleanUtils {
    ...
    public static Boolean and(final Boolean... array) {
        ObjectUtils.requireNonEmpty(array, "array");
        return and(cn.xutils.commons.ArrayUtils.toPrimitive(array)) ? Boolean.TRUE : Boolean.FALSE;
    }
     ...
     */
    public static Boolean oneHot(final Boolean... array) {
        return Boolean.valueOf(oneHot(cn.xutils.commons.ArrayUtils.toPrimitive(array)));
    }
    ...
    public static Boolean or(final Boolean... array) {
        ObjectUtils.requireNonEmpty(array, "array");
        return or(cn.xutils.commons.ArrayUtils.toPrimitive(array)) ? Boolean.TRUE : Boolean.FALSE;
    }
