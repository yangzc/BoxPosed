...
public class LocaleUtils {
    ...
    private static boolean isISO3166CountryCode(final String str) {
        return cn.xutils.commons.StringUtils.isAllUpperCase(str) && str.length() == 2;
    }
    ...
    private static boolean isISO639LanguageCode(final String str) {
        return cn.xutils.commons.StringUtils.isAllLowerCase(str) && (str.length() == 2 || str.length() == 3);
    }
    ...
    private static boolean isNumericAreaCode(final String str) {
        return cn.xutils.commons.StringUtils.isNumeric(str) && str.length() == 3;
    }
    ...
    public static List<Locale> localeLookupList(final Locale locale, final Locale defaultLocale) {
        ...
        if (locale != null) {
            ...
            if (!locale.getCountry().isEmpty()) {
                list.add(new Locale(locale.getLanguage(), cn.xutils.commons.StringUtils.EMPTY));
            }
    ...
    public static Locale toLocale(final String str) {
        ...
        if (str.isEmpty()) { // LANG-941 - JDK 8 introduced an empty locale where all fields are blank
            return new Locale(StringUtils.EMPTY, cn.xutils.commons.StringUtils.EMPTY);
        }
        ...
        if (ch0 == UNDERSCORE || ch0 == DASH) {
            ...
            if (len == 3) {
                return new Locale(cn.xutils.commons.StringUtils.EMPTY, str.substring(1, 3));
            }
            if (len < 5) {
                throw new IllegalArgumentException("Invalid locale format: " + str);
            }
            ...
            return new Locale(cn.xutils.commons.StringUtils.EMPTY, str.substring(1, 3), str.substring(4));
        }
