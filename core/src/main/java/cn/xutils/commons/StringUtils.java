...
import cn.xutils.commons.function.Suppliers;
import cn.xutils.commons.function.ToBooleanBiFunction;
import cn.xutils.commons.stream.LangCollectors;
import cn.xutils.commons.stream.Streams;
...
public class StringUtils {
    ...
    private static String appendIfMissing(final String str, final CharSequence suffix, final boolean ignoreCase, final CharSequence... suffixes) {
        ...
        if (cn.xutils.commons.ArrayUtils.isNotEmpty(suffixes)) {
    ...
    public static boolean contains(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchSeq, 0) >= 0;
    }
    ...
    public static boolean contains(final CharSequence seq, final int searchChar) {
        ...
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchChar, 0) >= 0;
    }
    ...
    public static boolean containsAny(final CharSequence cs, final char... searchChars) {
        if (isEmpty(cs) || cn.xutils.commons.ArrayUtils.isEmpty(searchChars)) {
            return false;
        }
    ...
    public static boolean containsAny(final CharSequence cs, final CharSequence searchChars) {
        ...
        return containsAny(cs, cn.xutils.commons.CharSequenceUtils.toCharArray(searchChars));
    }
    ...
    private static boolean containsAny(final ToBooleanBiFunction<CharSequence, CharSequence> test,
        ...
        if (isEmpty(cs) || cn.xutils.commons.ArrayUtils.isEmpty(searchCharSequences)) {
            return false;
        }
    ...
    public static boolean containsIgnoreCase(final CharSequence str, final CharSequence searchStr) {
        ...
        for (int i = 0; i <= max; i++) {
            if (cn.xutils.commons.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, len)) {
                return true;
            }
        }
        return false;
    ...
    public static int countMatches(final CharSequence str, final CharSequence sub) {
        ...
        int count = 0;
        int idx = 0;
        while ((idx = cn.xutils.commons.CharSequenceUtils.indexOf(str, sub, idx)) != INDEX_NOT_FOUND) {
            count++;
            idx += sub.length();
        }
        return count;
    ...
    private static boolean endsWith(final CharSequence str, final CharSequence suffix, final boolean ignoreCase) {
        ...
        return cn.xutils.commons.CharSequenceUtils.regionMatches(str, ignoreCase, strOffset, suffix, 0, suffix.length());
    }
    ...
    public static boolean endsWithAny(final CharSequence sequence, final CharSequence... searchStrings) {
        if (isEmpty(sequence) || cn.xutils.commons.ArrayUtils.isEmpty(searchStrings)) {
            return false;
        }
    ...
    public static boolean equalsAny(final CharSequence string, final CharSequence... searchStrings) {
        if (cn.xutils.commons.ArrayUtils.isNotEmpty(searchStrings)) {
    ...
    public static boolean equalsIgnoreCase(final CharSequence cs1, final CharSequence cs2) {
        ...
        return cn.xutils.commons.CharSequenceUtils.regionMatches(cs1, true, 0, cs2, 0, cs1.length());
    }
    ...
    public static byte[] getBytes(final String string, final Charset charset) {
        return string == null ? cn.xutils.commons.ArrayUtils.EMPTY_BYTE_ARRAY : string.getBytes(Charsets.toCharset(charset));
    }
    ...
    public static byte[] getBytes(final String string, final String charset) throws UnsupportedEncodingException {
        return string == null ? cn.xutils.commons.ArrayUtils.EMPTY_BYTE_ARRAY : string.getBytes(Charsets.toCharsetName(charset));
    }
    ...
    public static String getCommonPrefix(final String... strs) {
        if (cn.xutils.commons.ArrayUtils.isEmpty(strs)) {
            return EMPTY;
        }
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchSeq, 0);
    }
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
        ...
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchSeq, startPos);
    }
     ...
     * @since 3.6 Updated {@link cn.xutils.commons.CharSequenceUtils} call to behave more like {@link String}
     */
    public static int indexOf(final CharSequence seq, final int searchChar) {
        if (isEmpty(seq)) {
            return INDEX_NOT_FOUND;
        }
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchChar, 0);
    }
    ...
    public static int indexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return cn.xutils.commons.CharSequenceUtils.indexOf(seq, searchChar, startPos);
    }
    ...
    public static int indexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = cn.xutils.commons.CharSequenceUtils.indexOf(str, search, 0);
    ...
    public static int indexOfAnyBut(final CharSequence seq, final CharSequence searchChars) {
        ...
        for (int i = 0; i < strLen; i++) {
            ...
            final boolean chFound = cn.xutils.commons.CharSequenceUtils.indexOf(searchChars, ch, 0) >= 0;
            if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
                final char ch2 = seq.charAt(i + 1);
                if (chFound && cn.xutils.commons.CharSequenceUtils.indexOf(searchChars, ch2, 0) < 0) {
                    return i;
                }
            } else if (!chFound) {
                return i;
    ...
    public static int indexOfDifference(final CharSequence... css) {
        if (cn.xutils.commons.ArrayUtils.getLength(css) <= 1) {
            return INDEX_NOT_FOUND;
        }
    ...
    public static int indexOfIgnoreCase(final CharSequence str, final CharSequence searchStr, int startPos) {
        ...
        for (int i = startPos; i < endLimit; i++) {
            if (cn.xutils.commons.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, searchStr.length())) {
                return i;
            }
        }
        return INDEX_NOT_FOUND;
    ...
    public static boolean isAllBlank(final CharSequence... css) {
        if (cn.xutils.commons.ArrayUtils.isEmpty(css)) {
            return true;
        }
        for (final CharSequence cs : css) {
            if (isNotBlank(cs)) {
    ...
    public static int lastIndexOf(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return cn.xutils.commons.CharSequenceUtils.lastIndexOf(seq, searchSeq, seq.length());
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
        return cn.xutils.commons.CharSequenceUtils.lastIndexOf(seq, searchSeq, startPos);
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar) {
        ...
        return cn.xutils.commons.CharSequenceUtils.lastIndexOf(seq, searchChar, seq.length());
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return cn.xutils.commons.CharSequenceUtils.lastIndexOf(seq, searchChar, startPos);
    }
    ...
    public static int lastIndexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = cn.xutils.commons.CharSequenceUtils.lastIndexOf(str, search, str.length());
            if (tmp > ret) {
                ret = tmp;
            }
        }
    ...
    public static int lastIndexOfIgnoreCase(final CharSequence str, final CharSequence searchStr, int startPos) {
        ...
        for (int i = startPos; i >= 0; i--) {
            if (cn.xutils.commons.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, searchStrLength)) {
                return i;
            }
        }
        return INDEX_NOT_FOUND;
    ...
    private static int ordinalIndexOf(final CharSequence str, final CharSequence searchStr, final int ordinal, final boolean lastIndex) {
        ...
        do {
            if (lastIndex) {
                index = cn.xutils.commons.CharSequenceUtils.lastIndexOf(str, searchStr, index - 1); // step backwards through string
            } else {
                index = cn.xutils.commons.CharSequenceUtils.indexOf(str, searchStr, index + 1); // step forwards through string
            }
            if (index < 0) {
                return index;
            }
    ...
    private static String prependIfMissing(final String str, final CharSequence prefix, final boolean ignoreCase, final CharSequence... prefixes) {
        ...
        if (cn.xutils.commons.ArrayUtils.isNotEmpty(prefixes)) {
    ...
    private static String replaceEach(
        ...
        if (isEmpty(text) || cn.xutils.commons.ArrayUtils.isEmpty(searchList) || cn.xutils.commons.ArrayUtils.isEmpty(replacementList) || cn.xutils.commons.ArrayUtils.isNotEmpty(searchList) && timeToLive == -1) {
            return text;
        }
    ...
    public static String replaceEachRepeatedly(final String text, final String[] searchList, final String[] replacementList) {
        return replaceEach(text, searchList, replacementList, true, cn.xutils.commons.ArrayUtils.getLength(searchList));
    }
    ...
    public static String reverseDelimited(final String str, final char separatorChar) {
        ...
        cn.xutils.commons.ArrayUtils.reverse(strs);
    ...
    private static String[] splitByCharacterType(final String str, final boolean camelCase) {
        ...
        if (str.isEmpty()) {
            return cn.xutils.commons.ArrayUtils.EMPTY_STRING_ARRAY;
        }
        ...
        return list.toArray(cn.xutils.commons.ArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    private static String[] splitByWholeSeparatorWorker(
        ...
        return substrings.toArray(cn.xutils.commons.ArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    public static String[] stripAll(final String[] strs, final String stripChars) {
        final int strsLen = cn.xutils.commons.ArrayUtils.getLength(strs);
        if (strsLen == 0) {
            return strs;
        }
