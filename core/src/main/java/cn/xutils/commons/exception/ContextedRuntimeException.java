 ...
 */
package cn.xutils.commons.exception;

import java.util.List;
import java.util.Set;

import cn.xutils.commons.tuple.Pair;
 ...
 * @since 3.0
 */
public class ContextedRuntimeException extends RuntimeException implements cn.xutils.commons.exception.ExceptionContext {

    /** The serialization version. */
    private static final long serialVersionUID = 20110706L;
    /** The context where the data is stored. */
    private final cn.xutils.commons.exception.ExceptionContext exceptionContext;
