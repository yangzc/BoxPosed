...
import cn.xutils.commons.ArraySorter;
 ...
 * </pre>
 *
 * <p>The {@link cn.xutils.commons.builder.HashCodeExclude} annotation can be used to exclude fields from being
...
public class HashCodeBuilder implements Builder<Integer> {
        ...
        try {
            ...
            for (final Field field : fields) {
                if (!ArrayUtils.contains(excludeFields, field.getName())
                    ...
                    && !field.isAnnotationPresent(cn.xutils.commons.builder.HashCodeExclude.class)) {
     ...
     *
     * @see cn.xutils.commons.builder.HashCodeExclude
     */
