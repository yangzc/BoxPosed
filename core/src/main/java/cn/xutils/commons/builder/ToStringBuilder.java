...
import cn.xutils.commons.ObjectUtils;
 ...
 * the {@link cn.xutils.commons.builder.ToStringStyle} passed into the constructor.</p>
 *
 * @since 1.0
 */
public class ToStringBuilder implements Builder<String> {
     ...
     */
    private static volatile cn.xutils.commons.builder.ToStringStyle defaultStyle = cn.xutils.commons.builder.ToStringStyle.DEFAULT_STYLE;

    /**
     * Gets the default {@link cn.xutils.commons.builder.ToStringStyle} to use.
     *
     * <p>This method gets a singleton default value, typically for the whole JVM.
     * Changing this default should generally only be done during application startup.
     * It is recommended to pass a {@link cn.xutils.commons.builder.ToStringStyle} to the constructor instead
     ...
     *
     * @return the default {@link cn.xutils.commons.builder.ToStringStyle}, never null
     */
    public static cn.xutils.commons.builder.ToStringStyle getDefaultStyle() {
        return defaultStyle;
    }

    /**
     * Sets the default {@link cn.xutils.commons.builder.ToStringStyle} to use.
     *
     ...
     *
     * @param style  the default {@link cn.xutils.commons.builder.ToStringStyle}
     * @throws NullPointerException if the style is {@code null}
     */
    public static void setDefaultStyle(final cn.xutils.commons.builder.ToStringStyle style) {
        defaultStyle = Objects.requireNonNull(style, "style");
    }

    /**
     * Uses {@link cn.xutils.commons.builder.ReflectionToStringBuilder} to generate a
     * {@code toString} for the specified object.
     *
     * @param object  the Object to be output
     * @return the String result
     * @see cn.xutils.commons.builder.ReflectionToStringBuilder#toString(Object)
     */
    public static String reflectionToString(final Object object) {
        return cn.xutils.commons.builder.ReflectionToStringBuilder.toString(object);
    }
     ...
     * @return the String result
     * @see cn.xutils.commons.builder.ReflectionToStringBuilder#toString(Object, cn.xutils.commons.builder.ToStringStyle)
     */
    public static String reflectionToString(final Object object, final cn.xutils.commons.builder.ToStringStyle style) {
        return cn.xutils.commons.builder.ReflectionToStringBuilder.toString(object, style);
    }
     ...
     * @return the String result
     * @see cn.xutils.commons.builder.ReflectionToStringBuilder#toString(Object, cn.xutils.commons.builder.ToStringStyle,boolean)
     */
    public static String reflectionToString(final Object object, final cn.xutils.commons.builder.ToStringStyle style, final boolean outputTransients) {
        return cn.xutils.commons.builder.ReflectionToStringBuilder.toString(object, style, outputTransients, false, null);
    }
     ...
     * @return the String result
     * @see cn.xutils.commons.builder.ReflectionToStringBuilder#toString(Object, cn.xutils.commons.builder.ToStringStyle,boolean,boolean,Class)
     * @since 2.0
     */
     ...
     */
    public ToStringBuilder(final Object object, final cn.xutils.commons.builder.ToStringStyle style) {
     ...
     */
    public ToStringBuilder(final Object object, cn.xutils.commons.builder.ToStringStyle style, StringBuffer buffer) {
        if (style == null) {
     ...
     *
     * <p>This method assumes that the superclass uses the same {@link cn.xutils.commons.builder.ToStringStyle}
     * as this one.</p>
     *
     ...
     *   }</pre>
     *
     * <p>This method assumes that the other object uses the same {@link cn.xutils.commons.builder.ToStringStyle}
     * as this one.</p>
     *
    ...
    /**
     * Gets the {@link cn.xutils.commons.builder.ToStringStyle} being used.
     *
     * @return the {@link cn.xutils.commons.builder.ToStringStyle} being used
     * @since 2.0
     */
