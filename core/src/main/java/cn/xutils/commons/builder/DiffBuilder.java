...
/**
 * Assists in implementing {@link cn.xutils.commons.builder.Diffable#diff(Object)} methods.
 *
 * <p>
 ...
 *
 * <p>
 * The {@link cn.xutils.commons.builder.ToStringStyle} passed to the constructor is embedded in the
 * returned {@link cn.xutils.commons.builder.DiffResult} and influences the style of the
 * {@code DiffResult.toString()} method. This style choice can be overridden by
 * calling {@link cn.xutils.commons.builder.DiffResult#toString(cn.xutils.commons.builder.ToStringStyle)}.
 * </p>
 * <p>
 * See {@link cn.xutils.commons.builder.ReflectionDiffBuilder} for a reflection based version of this class.
 * </p>
 *
 * @param <T> type of the left and right object.
 * @see Diffable
 * @see cn.xutils.commons.builder.Diff
 * @see cn.xutils.commons.builder.DiffResult
 * @see cn.xutils.commons.builder.ToStringStyle
 * @see ReflectionDiffBuilder
 * @since 3.3
 */
public class DiffBuilder<T> implements Builder<cn.xutils.commons.builder.DiffResult<T>> {

    private final List<cn.xutils.commons.builder.Diff<?>> diffs;
     ...
     * {@link cn.xutils.commons.builder.DiffResult} when {@link #build()} is executed.
     * </p>
     *
     * @param lhs
     *            {@code this} object
     ...
     *            without creating a field {@link cn.xutils.commons.builder.Diff} if the trivially equal
    ...
    public DiffBuilder(final T lhs, final T rhs,
                       final cn.xutils.commons.builder.ToStringStyle style, final boolean testTriviallyEqual) {
     ...
     *
     * <p>
     * This delegates to {@link #DiffBuilder(Object, Object, cn.xutils.commons.builder.ToStringStyle, boolean)}
    ...
    public DiffBuilder<T> append(final String fieldName, final boolean lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Boolean>(fieldName) {
    ...
    public DiffBuilder<T> append(final String fieldName, final byte lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Byte>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final char lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Character>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final double lhs,
        ...
        if (Double.doubleToLongBits(lhs) != Double.doubleToLongBits(rhs)) {
            diffs.add(new cn.xutils.commons.builder.Diff<Double>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final float lhs,
        ...
        if (Float.floatToIntBits(lhs) != Float.floatToIntBits(rhs)) {
            diffs.add(new cn.xutils.commons.builder.Diff<Float>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final int lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Integer>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final long lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Long>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final short lhs,
        ...
        if (lhs != rhs) {
            diffs.add(new cn.xutils.commons.builder.Diff<Short>(fieldName) {
                private static final long serialVersionUID = 1L;
    ...
    public DiffBuilder<T> append(final String fieldName, final Object lhs,
        ...
        diffs.add(new cn.xutils.commons.builder.Diff<Object>(fieldName) {
            private static final long serialVersionUID = 1L;
    ...
    /**
     * Append diffs from another {@link cn.xutils.commons.builder.DiffResult}.
     *
     * <p>
     ...
     *            the field name
     * @param diffResult
     *            the {@link cn.xutils.commons.builder.DiffResult} to append
     * @return this
     * @throws NullPointerException if field name is {@code null} or diffResult is {@code null}
     * @since 3.5
     */
    public DiffBuilder<T> append(final String fieldName, final cn.xutils.commons.builder.DiffResult<T> diffResult) {
        validateFieldNameNotNull(fieldName);
    ...
    /**
     * Builds a {@link cn.xutils.commons.builder.DiffResult} based on the differences appended to this
     * builder.
     *
     * @return a {@link cn.xutils.commons.builder.DiffResult} containing the differences between the two
     *         objects.
     */
    @Override
    public cn.xutils.commons.builder.DiffResult<T> build() {
