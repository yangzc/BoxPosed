 ...
 * </p>
 * <p>Additionally {@link TypeLiteral} implements the {@link cn.xutils.commons.reflect.Typed} interface which
...
public abstract class TypeLiteral<T> implements Typed<T> {
    ...
    protected TypeLiteral() {
        this.value =
            Validate.notNull(cn.xutils.commons.reflect.TypeUtils.getTypeArguments(getClass(), TypeLiteral.class).get(T),
                "%s does not assign type parameter %s", getClass(), cn.xutils.commons.reflect.TypeUtils.toLongString(T));

        this.toString = String.format("%s<%s>", TypeLiteral.class.getSimpleName(), cn.xutils.commons.reflect.TypeUtils.toString(value));
    }
