 ...
 * {@link cn.xutils.commons.reflect.MethodUtils}.
 *
...
public class ConstructorUtils {
    ...
    public static <T> Constructor<T> getAccessibleConstructor(final Constructor<T> ctor) {
        ...
        return cn.xutils.commons.reflect.MemberUtils.isAccessible(ctor)
    ...
    public static <T> Constructor<T> getMatchingAccessibleConstructor(final Class<T> cls,
        ...
        try {
            return cn.xutils.commons.reflect.MemberUtils.setAccessibleWorkaround(cls.getConstructor(parameterTypes));
        ...
        for (Constructor<?> ctor : ctors) {
            // compare parameters
            if (cn.xutils.commons.reflect.MemberUtils.isMatchingConstructor(ctor, parameterTypes)) {
                // get accessible version of constructor
                ctor = getAccessibleConstructor(ctor);
                if (ctor != null) {
                    cn.xutils.commons.reflect.MemberUtils.setAccessibleWorkaround(ctor);
                    if (result == null || cn.xutils.commons.reflect.MemberUtils.compareConstructorFit(ctor, result, parameterTypes) < 0) {
