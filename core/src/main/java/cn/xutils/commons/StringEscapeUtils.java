...
import cn.xutils.commons.text.translate.AggregateTranslator;
import cn.xutils.commons.text.translate.CharSequenceTranslator;
import cn.xutils.commons.text.translate.EntityArrays;
import cn.xutils.commons.text.translate.JavaUnicodeEscaper;
import cn.xutils.commons.text.translate.LookupTranslator;
import cn.xutils.commons.text.translate.NumericEntityEscaper;
import cn.xutils.commons.text.translate.NumericEntityUnescaper;
import cn.xutils.commons.text.translate.OctalUnescaper;
import cn.xutils.commons.text.translate.UnicodeUnescaper;
import cn.xutils.commons.text.translate.UnicodeUnpairedSurrogateRemover;
...
public class StringEscapeUtils {
    ...
    public static final CharSequenceTranslator ESCAPE_XML10 =
        new AggregateTranslator(
            ...
            new LookupTranslator(
                    new String[][] {
                            { "\u0000", cn.xutils.commons.StringUtils.EMPTY },
                            { "\u0001", cn.xutils.commons.StringUtils.EMPTY },
                            { "\u0002", cn.xutils.commons.StringUtils.EMPTY },
                            { "\u0003", cn.xutils.commons.StringUtils.EMPTY },
                            { "\u0004", cn.xutils.commons.StringUtils.EMPTY },
    ...
    static class CsvEscaper extends CharSequenceTranslator {
        ...
        public int translate(final CharSequence input, final int index, final Writer out) throws IOException {
            ...
            if (cn.xutils.commons.StringUtils.containsNone(input.toString(), CSV_SEARCH_CHARS)) {
                out.write(input.toString());
            } else {
                out.write(CSV_QUOTE);
                out.write(cn.xutils.commons.StringUtils.replace(input.toString(), CSV_QUOTE_STR, CSV_QUOTE_STR + CSV_QUOTE_STR));
                out.write(CSV_QUOTE);
            }
    ...
    static class CsvUnescaper extends CharSequenceTranslator {
        ...
        public int translate(final CharSequence input, final int index, final Writer out) throws IOException {
            ...
            if ( cn.xutils.commons.StringUtils.containsAny(quoteless, CSV_SEARCH_CHARS) ) {
                // deal with escaped quotes; ie) ""
                out.write(cn.xutils.commons.StringUtils.replace(quoteless, CSV_QUOTE_STR + CSV_QUOTE_STR, CSV_QUOTE_STR));
            } else {
                out.write(input.toString());
            }
            return Character.codePointCount(input, 0, input.length());
