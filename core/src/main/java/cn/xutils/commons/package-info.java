...
// * However {@link cn.xutils.commons.CharSet} is not currently guaranteed thread-safe under all circumstances.
// *
...
// * The first is {@link cn.xutils.commons.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
// * In addition to StringUtils, there are a series of other String manipulating classes; {@link cn.xutils.commons.RandomStringUtils} and {@link cn.xutils.commons.StringEscapeUtils StringEscapeUtils}.
...
// * StringUtils' {@link cn.xutils.commons.StringUtils#capitalize(String)}, {@link cn.xutils.commons.StringUtils#substringBetween(String, String)}/{@link cn.xutils.commons.StringUtils#substringBefore(String, String) Before}/{@link cn.xutils.commons.StringUtils#substringAfter(String, String) After}, {@link cn.xutils.commons.StringUtils#split(String)} and {@link cn.xutils.commons.StringUtils#join(Object[])} are good methods to begin with.</p>
// *
...
// * {@link cn.xutils.commons.CharUtils} exists for this purpose, while {@link cn.xutils.commons.CharSetUtils} exists for set-manipulation of Strings.
...
// *
// * <p>{@link cn.xutils.commons.CharRange} and {@link cn.xutils.commons.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
// *
...
// *
// * <p>The {@link cn.xutils.commons.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment.</p>
// *
...
// *
// * <p>Would you believe it, {@link cn.xutils.commons.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
// *
// * <p>{@link cn.xutils.commons.ClassUtils} is largely a set of helper methods for reflection.
...
// *
// * <p>Next up, {@link cn.xutils.commons.ArrayUtils}.
...
// * </ul>
// *
// * <p>Lastly, {@link cn.xutils.commons.ArrayUtils#toMap(Object[])} is worthy of special note.
...
// * </pre>
// *
// * <p>Our final util class is {@link cn.xutils.commons.BooleanUtils}.
// * It contains various Boolean acting methods, probably of most interest is the {@link cn.xutils.commons.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
// *
...
// * <p>The {@link cn.xutils.commons.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link cn.xutils.commons.Validate} class may be used for assertions (remember, we support Java 1.2).</p>
// *
// * @since 1.0
// */
