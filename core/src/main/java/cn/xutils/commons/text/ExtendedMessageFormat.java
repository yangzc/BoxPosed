 ...
 * of {@link cn.xutils.commons.text.FormatFactory} instances associated with {@link String}
...
public class ExtendedMessageFormat extends MessageFormat {
     ...
     */
    private final Map<String, ? extends cn.xutils.commons.text.FormatFactory> registry;
     ...
     * @throws IllegalArgumentException in case of a bad pattern.
     */
    public ExtendedMessageFormat(final String pattern, final Map<String, ? extends cn.xutils.commons.text.FormatFactory> registry) {
     ...
     * @throws IllegalArgumentException in case of a bad pattern.
     */
    public ExtendedMessageFormat(final String pattern, final Locale locale, final Map<String, ? extends cn.xutils.commons.text.FormatFactory> registry) {
        super(DUMMY_PATTERN);
