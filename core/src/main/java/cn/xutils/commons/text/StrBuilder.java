...
import cn.xutils.commons.CharUtils;
import cn.xutils.commons.StringUtils;

import cn.xutils.commons.builder.Builder;
...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
     ...
     * @return this, to enable chaining
     */
    public StrBuilder deleteAll(final cn.xutils.commons.text.StrMatcher matcher) {
     ...
     * @return this, to enable chaining
     */
    public StrBuilder deleteFirst(final cn.xutils.commons.text.StrMatcher matcher) {
        return replace(matcher, null, 0, size, 1);
    }
     ...
     * @return this, to enable chaining
     */
    public StrBuilder replaceAll(final cn.xutils.commons.text.StrMatcher matcher, final String replaceStr) {
     ...
     * @return this, to enable chaining
     */
    public StrBuilder replaceFirst(final cn.xutils.commons.text.StrMatcher matcher, final String replaceStr) {
        return replace(matcher, replaceStr, 0, size, 1);
    }
    ...
    public StrBuilder replace(
            final cn.xutils.commons.text.StrMatcher matcher, final String replaceStr,
     ...
     */
    public boolean contains(final cn.xutils.commons.text.StrMatcher matcher) {
     ...
     */
    public int indexOf(final cn.xutils.commons.text.StrMatcher matcher) {
     ...
     * @return the first index matched, or -1 if not found
     */
    public int indexOf(final cn.xutils.commons.text.StrMatcher matcher, int startIndex) {
        startIndex = Math.max(startIndex, 0);
     ...
     */
    public int lastIndexOf(final cn.xutils.commons.text.StrMatcher matcher) {
