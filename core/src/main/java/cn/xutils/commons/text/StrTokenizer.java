...
import cn.xutils.commons.ArrayUtils;
 ...
 * to do a similar job to {@link StringTokenizer StringTokenizer},
...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    static {
        ...
        CSV_TOKENIZER_PROTOTYPE.setDelimiterMatcher(cn.xutils.commons.text.StrMatcher.commaMatcher());
        CSV_TOKENIZER_PROTOTYPE.setQuoteMatcher(cn.xutils.commons.text.StrMatcher.doubleQuoteMatcher());
        CSV_TOKENIZER_PROTOTYPE.setIgnoredMatcher(cn.xutils.commons.text.StrMatcher.noneMatcher());
        CSV_TOKENIZER_PROTOTYPE.setTrimmerMatcher(cn.xutils.commons.text.StrMatcher.trimMatcher());
        CSV_TOKENIZER_PROTOTYPE.setEmptyTokenAsNull(false);
        CSV_TOKENIZER_PROTOTYPE.setIgnoreEmptyTokens(false);

        TSV_TOKENIZER_PROTOTYPE = new StrTokenizer();
        TSV_TOKENIZER_PROTOTYPE.setDelimiterMatcher(cn.xutils.commons.text.StrMatcher.tabMatcher());
        TSV_TOKENIZER_PROTOTYPE.setQuoteMatcher(cn.xutils.commons.text.StrMatcher.doubleQuoteMatcher());
        TSV_TOKENIZER_PROTOTYPE.setIgnoredMatcher(cn.xutils.commons.text.StrMatcher.noneMatcher());
        TSV_TOKENIZER_PROTOTYPE.setTrimmerMatcher(cn.xutils.commons.text.StrMatcher.trimMatcher());
    ...
    private cn.xutils.commons.text.StrMatcher delimMatcher = cn.xutils.commons.text.StrMatcher.splitMatcher();
    /** The quote matcher */
    private cn.xutils.commons.text.StrMatcher quoteMatcher = cn.xutils.commons.text.StrMatcher.noneMatcher();
    /** The ignored matcher */
    private cn.xutils.commons.text.StrMatcher ignoredMatcher = cn.xutils.commons.text.StrMatcher.noneMatcher();
    /** The trimmer matcher */
    private cn.xutils.commons.text.StrMatcher trimmerMatcher = cn.xutils.commons.text.StrMatcher.noneMatcher();
     ...
     */
    public StrTokenizer(final String input, final cn.xutils.commons.text.StrMatcher delim) {
        this(input);
     ...
     */
    public StrTokenizer(final String input, final cn.xutils.commons.text.StrMatcher delim, final cn.xutils.commons.text.StrMatcher quote) {
        this(input, delim);
     ...
     * @param delim  the field delimiter matcher
     */
    public StrTokenizer(final char[] input, final cn.xutils.commons.text.StrMatcher delim) {
        this(input);
        setDelimiterMatcher(delim);
    }
     ...
     * @param quote  the field quoted string character
     */
    public StrTokenizer(final char[] input, final cn.xutils.commons.text.StrMatcher delim, final cn.xutils.commons.text.StrMatcher quote) {
        this(input, delim);
        setQuoteMatcher(quote);
    }
    ...
    protected List<String> tokenize(final char[] srcChars, final int offset, final int count) {
        ...
        final cn.xutils.commons.text.StrBuilder buf = new cn.xutils.commons.text.StrBuilder();
     ...
     */
    private int readNextToken(final char[] srcChars, int start, final int len, final cn.xutils.commons.text.StrBuilder workArea, final List<String> tokenList) {
     ...
     */
    public cn.xutils.commons.text.StrMatcher getDelimiterMatcher() {
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setDelimiterMatcher(final cn.xutils.commons.text.StrMatcher delim) {
        if (delim == null) {
            this.delimMatcher = cn.xutils.commons.text.StrMatcher.noneMatcher();
        } else {
    ...
    public StrTokenizer setDelimiterChar(final char delim) {
        return setDelimiterMatcher(cn.xutils.commons.text.StrMatcher.charMatcher(delim));
    }
    ...
    public StrTokenizer setDelimiterString(final String delim) {
        return setDelimiterMatcher(cn.xutils.commons.text.StrMatcher.stringMatcher(delim));
    }
     ...
     */
    public cn.xutils.commons.text.StrMatcher getQuoteMatcher() {
        return quoteMatcher;
    }
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setQuoteMatcher(final cn.xutils.commons.text.StrMatcher quote) {
        if (quote != null) {
    ...
    public StrTokenizer setQuoteChar(final char quote) {
        return setQuoteMatcher(cn.xutils.commons.text.StrMatcher.charMatcher(quote));
    }
     ...
     */
    public cn.xutils.commons.text.StrMatcher getIgnoredMatcher() {
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setIgnoredMatcher(final cn.xutils.commons.text.StrMatcher ignored) {
        if (ignored != null) {
    ...
    public StrTokenizer setIgnoredChar(final char ignored) {
        return setIgnoredMatcher(cn.xutils.commons.text.StrMatcher.charMatcher(ignored));
    }
     ...
     */
    public cn.xutils.commons.text.StrMatcher getTrimmerMatcher() {
