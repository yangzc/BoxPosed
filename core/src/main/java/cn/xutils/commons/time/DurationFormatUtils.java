...
public class DurationFormatUtils {
    ...
    /**
     * Pattern used with {@link cn.xutils.commons.time.FastDateFormat} and {@link SimpleDateFormat}
    ...
    public static String formatDuration(final long durationMillis, final String format, final boolean padWithZeros) {
        ...
        if (Token.containsTokenWithValue(tokens, d)) {
            days = milliseconds / cn.xutils.commons.time.DateUtils.MILLIS_PER_DAY;
            milliseconds = milliseconds - (days * cn.xutils.commons.time.DateUtils.MILLIS_PER_DAY);
        }
        if (Token.containsTokenWithValue(tokens, H)) {
            hours = milliseconds / cn.xutils.commons.time.DateUtils.MILLIS_PER_HOUR;
            milliseconds = milliseconds - (hours * cn.xutils.commons.time.DateUtils.MILLIS_PER_HOUR);
        }
        if (Token.containsTokenWithValue(tokens, m)) {
            minutes = milliseconds / cn.xutils.commons.time.DateUtils.MILLIS_PER_MINUTE;
            milliseconds = milliseconds - (minutes * cn.xutils.commons.time.DateUtils.MILLIS_PER_MINUTE);
        }
        if (Token.containsTokenWithValue(tokens, s)) {
            seconds = milliseconds / cn.xutils.commons.time.DateUtils.MILLIS_PER_SECOND;
