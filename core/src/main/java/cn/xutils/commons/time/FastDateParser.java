...
import cn.xutils.commons.LocaleUtils;

/**
 * FastDateParser is a fast and thread-safe version of
 * {@link SimpleDateFormat}.
 *
 * <p>To obtain a proxy to a FastDateParser, use {@link cn.xutils.commons.time.FastDateFormat#getInstance(String, TimeZone, Locale)}
 * or another variation of the factory methods of {@link cn.xutils.commons.time.FastDateFormat}.</p>
 *
 ...
 * @see FastDatePrinter
 */
public class FastDateParser implements cn.xutils.commons.time.DateParser, Serializable {
     ...
     *
     * Use {@link cn.xutils.commons.time.FastDateFormat#getInstance(String, TimeZone, Locale)} or another variation of the
     * factory methods of {@link FastDateFormat} to get a cached FastDateParser instance.
     *
     * @param pattern non-null {@link SimpleDateFormat} compatible
     *  pattern
     ...
     * the method {@link SimpleDateFormat#parse(String, ParsePosition)} which sets
    ...
    static class TimeZoneStrategy extends PatternStrategy {
        ...
        private static final String GMT_OPTION = cn.xutils.commons.time.TimeZones.GMT_ID + "[+-]\\d{1,2}:\\d{2}";
        ...
        void setCalendar(final FastDateParser parser, final Calendar calendar, final String timeZone) {
            final TimeZone tz = cn.xutils.commons.time.FastTimeZone.getGmtTimeZone(timeZone);
            if (tz != null) {
